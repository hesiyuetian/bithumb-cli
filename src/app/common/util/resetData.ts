...
export class resetData {
    ...
    caleUSDT(tickerListObj: object): void{
        this.raleUSDTObject = {
            ...
            USDT: this.regular.toBigsells([1, this.USD], 4)
        };
    }
    ...
    matchPair(symbol: string, available: string, usdtVal: number, tickerListObj:any): string {
        if(symbol === "BTC") return available;
        return tickerListObj['BTC_USDT'] ? this.regular.toDividedByAry([usdtVal, tickerListObj['BTC_USDT']], 8) : '0'
    }
